			...
			<div class="row clearfix mapContainer">
				...
				<div class="span-50">
					...
					<div style="background-image:url('<?php echo get_template_directory_uri();?>/images/announcementsplaceholder1.jpg');background-repeat:no-repeat;background-position:center;position:absolute;top:0;bottom:0;right:0;left:0;opacity:0.5;-webkit-filter:opacity(.5);z-index:-4; "></div>
						...
						<div id="newsfeed_container" class="boxContent">
						
						<?php
						echo do_shortcode('[wp_rss_retriever url="http://news.cals.wisc.edu/feed/" orderby="date" items="2" excerpt="15" read_more="true" source="false" new_window="true" thumbnail="false" cache="7200"]'); 
						?>
						
						<a href="http://news.cals.wisc.edu" target="_blank" class="moreButton"><svg height="512px" id="Layer_1" style="enable-background:new 0 0 512 512;" version="1.1" viewBox="0 0 512 512" width="512px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><polygon points="160,128.4 192.3,96 352,256 352,256 352,256 192.3,416 160,383.6 287.3,256 "/></svg></a>
...
<?php wp_reset_query(); ?>
							<a href="http://www.today.wisc.edu/events/feed/272" class="moreButton"><svg height="512px" id="Layer_1" style="enable-background:new 0 0 512 512;" version="1.1" viewBox="0 0 512 512" width="512px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><polygon points="160,128.4 192.3,96 352,256 352,256 352,256 192.3,416 160,383.6 287.3,256 "/></svg></a>
